# The Catholic Encyclopedia — "Dogmatic Facts" (*by Daniel Coghlan, vol. V, 1909*)

**by Daniel Coghlan, in The Catholic Encyclopedia, vol. V (New York: Robert Appleton Company, 1909); Nihil obstat May 1, 1909, Remy Lafort; Imprimatur +John M. Farley, Archbishop of New York**

[Online Location of Text Here](https://www.newadvent.org/cathen/05092a.htm)

- *Text from the New Advent transcription (transcribed by Rev. Paul J. McDonald); the original article is in the public domain.*

- *Last Edit: July 5, 2026.*

- *Version: 1.0*

- *Selection pages: Catholic Encyclopedia, vol. V, s.v. "Dogmatic Facts" (complete article)*

*Note on this selection: the standard English-language reference article of the early twentieth century, complete. Three things make it load-bearing for this repository. (1) The opening example states the pope-case with a precision most manuals reserve for the schools: "it is a dogma of faith that every pontiff duly elected and recognized by the universal Church is a successor of Peter" — the universal Church's recognition standing inside the revealed universal itself, exactly the conditional whose minor premise the acceptance supplies (cf. the 1602 Báñez Assertio and the 1640 John of St. Thomas entry). (2) The closing section, "Faith and dogmatic facts," is a fair two-camp survey of the assent question: the divine-faith position (the duly-elected pope is "included in the general revealed proposition," hence formally revealed, de fide) against the ecclesiastical-faith position ("which some call mediate Divine faith"), for which the Church's infallibility in such definitions is "theologically certain" and "cannot lawfully be questioned" — the exact fault-line later fought over by Marín-Sola and García Martínez on one side and Lennerz, Aldama, and Salaverri on the other (see the 1924 Marín-Sola entry). (3) Against both Jansenist positions it insists that definitions of dogmatic facts "demand real internal assent" — respectful silence is not enough. Under the two-verdict distinction this repository observes, both camps reported here affirm the fact-side without qualification; the dispute is confined to the note.*
...
```json
{
  "title_original_long": "The Catholic Encyclopedia, s.v. Dogmatic Facts",
  "title_english_long": "The Catholic Encyclopedia: Dogmatic Facts",
  "title_original_short": "Catholic Encyclopedia",
  "title_english_short": "Catholic Encyclopedia",
  "excerpt_title": "Dogmatic Facts (complete article), vol. V",
  "author": "Daniel Coghlan",
  "author_anglicized": "Daniel Coghlan",
  "year_written": "1909",
  "year_published": "1909 (encyclopedia series 1907-1912)",
  "volume": "V",
  "edition": "First edition",
  "editors": [
    "Charles G. Herbermann et al."
  ],
  "publication_place": "New York: Robert Appleton Company",
  "chicago_citation": "Coghlan, Daniel. \"Dogmatic Facts.\" In The Catholic Encyclopedia, vol. 5. New York: Robert Appleton Company, 1909.",
  "last_edit": "July 5, 2026",
  "version": "1.0",
  "selection_pages": "vol. V, s.v. Dogmatic Facts",
  "OCR_by": "n/a (New Advent transcription by Rev. Paul J. McDonald)",
  "translation_by": "n/a (English original)",
  "url": "https://www.newadvent.org/cathen/05092a.htm"
}
```
